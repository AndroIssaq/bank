...
const Billing = () => {
  return (
    <section className=' flex items-start justify-between mt-[100px] gap-[70px] ss:flex-col sm:flex-col md:flex-col lg:flex-row flex-col ' >
        <div className="cards dark:text-black flex flex-col gap-3  flex-1">
            <img src={bill} alt="" />
        ...
        <div className='content flex ss:items-start sm:items-start items-center justify-center gap-8 flex-col flex-1 mt-16'>
            ...
            <p className={`${styles.paragraph} dark:text-black`}> Arcu tortor, purus in mattis at sed integer faucibus. Aliquet quis aliquet eget mauris tortor.ç Aliquet ultrices ac, ametau.</p>
