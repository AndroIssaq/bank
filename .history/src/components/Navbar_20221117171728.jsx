...
const Navbar = () => {
  ...
  return (
    <div>
    <nav className={ `flex w-full items-center justify-between py-6 ${darkMode ? 'dark' : ''}`} >
    ...
    </div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div</div></di/div</div>
  )
}
