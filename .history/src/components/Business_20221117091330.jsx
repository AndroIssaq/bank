...
const Business = () => {
  return (
    <section className=' flex items-start justify-between mt-[100px] gap-[100px] ss:flex-col sm:flex-col md:flex-col lg:flex-row flex-col ' >
        <div className='content flex ss:items-start sm:items-start items-center justify-center gap-8 flex-col flex-1 mt-9'>
            <h1 className=' text-slate-50 text-[45px] font-bold'> You do the business, <br className="sm:block hidden" /> we well handle
                the money.
            </h1>
        ...
        <div className="cards flex flex-col gap-3  flex-1">
            {features.map(feature=>{
                return (
                    <A.div className="card  flex items-center gap-[20px] feature-card p-6 rounded-xl transition duration-500">
                        <div>
