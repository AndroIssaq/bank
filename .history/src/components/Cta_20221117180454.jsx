...
const Cta = () => {
  return (
    <section className='flex items-center justify-between w-full mt-[100px]  dark:bg-slate-600  bg-black-gradient p-[40px] rounded-xl xs:flex-row sm:flex-row flex-col gap-9'>
