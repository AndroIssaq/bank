...
const Business = () => {
  return (
    <section className=' flex items-start justify-between mt-[100px] gap-[100px] ss:flex-col sm:flex-col md:flex-col lg:flex-row flex-col ' >
        <div 
         initial= {{ x:"-100%" }}  
            animate={{ x: 0 }} className='content flex ss:items-start sm:items-start items-center justify-center gap-8 flex-col flex-1 mt-9'>
      
            <motion.h1 className=' text-slate-50 text-[45px] font-bold'
