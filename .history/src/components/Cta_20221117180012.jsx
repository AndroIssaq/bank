...
const Cta = () => {
  return (
    <section className='flex items-center justify-between w-full mt-[100px] bg-black-gradient bg-slate-500 p-[40px] rounded-xl xs:flex-row sm:flex-row flex-col gap-9'>
