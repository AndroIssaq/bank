...
const Cta = () => {
  return (
    <section className='flex items-center justify-between w-full mt-[100px] bg-black-gradient p-[40px] rounded-xl xs:flex-row sm:flex-row flex-col'>
        <div className="left w-[600px] flex flex-col gap-4">
